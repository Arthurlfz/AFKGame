 ...
 *    这里只配"这个怪是什么"（名字/类型/蛋映射/掉落倾向）。
 *  - 头像/立绘不在这里配（2026-09-10 移除 emoji 占位）：由 PetSprites 按名字解析真实素材。
 *  - 提供野怪池数据，不参与宠物进化、融合、变异逻辑。
 * ============================================================ */
window.EnemyData = {
  list: [
    /* ---- 第 1 档（图 1，1~10 级）---- */
    { id: 'wild-rotten', name: '腐噜兽', level: 6, spd: 55,
