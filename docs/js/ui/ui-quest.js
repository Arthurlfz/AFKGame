    ...
    return `
      <div class="quest-card${q.petName ? ' bind' : ''}" data-id="${q.id}">
        <div class="quest-card-head">
          ...
          ${q.petName ? `<span class="quest-card-pet"><svg class="eic" viewBox="0 0 24 24" aria-hidden="true"><path d="M5.2 10.8a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/><path d="M12 8.6a2.6 2.6 0 1 0 0-5.2 2.6 2.6 0 0 0 0 5.2z"/><path d="M18.8 10.8a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/><path d="M12 13.2c-3 0-4.8 1.7-4.8 3.9 0 2.4 1.8 4.4 4.8 4.4s4.8-2 4.8-4.4c0-2.2-1.8-3.9-4.8-3.9z"/></svg> ${escapeHtml(q.petName)}</span>` : ''}
        </div>
