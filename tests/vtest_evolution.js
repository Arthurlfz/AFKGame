...
C('Config.drop.materialWeightsByTier = { 1: { "进化素材":1 } }'); // 只掉进化素材（图1档），便于断言
const rr = await C('Drop.rollReward({ eggBaseName:null }, { id:"corrupted-forest" })'); // 图1（corrupted-forest）有进化素材档
